...
\begin{frame}{La matemática: ecuación GKSL y autovalores\J}
  ...
  \begin{column}{0.38\textwidth}
    \centering
    \includegraphics[width=\linewidth]{juan/T1/results/t1_eigs.png}\\
    {\scriptsize\textcolor{soft}{Espectro $\lambda_k$ del Liouvilliano.}}
  \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Conclusiones — HPC y física\J}
  ...
  \begin{column}{0.5\textwidth}
    ...
    \begin{itemize}\small
      ...
      \item \cs{Cruce reproducido por los 3 métodos} de evolución
        ($t^*\!\approx\!0.69$–$0.75$), validado de forma cruzada.
